	...
	RequestAnimDict('ultra@walkie_talkie')
			...
			CreateThread(function()
				...
				while radioPressed do
                    ...
                    TaskPlayAnim(PlayerPedId(), "ultra@walkie_talkie", "walkie_talkie", 8.0, 2.0, -1, 50, 0, false, false, false)
                 end
			end
...
function AttachRadioProp()
    ...
    AttachEntityToEntity(radioProp, playerPed, GetPedBoneIndex(playerPed, 18905), 0.14, 0.03, 0.03, -105.877, -10.9432, -33.7212, true, true, false, true, 1, true)
end
